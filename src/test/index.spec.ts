...
describe('main tests', () => {
  ...
  const startTest = async (paths: string[], config: InlineConfig = {}): Promise<void> => {
  ...
  it.only('should exclude case when miss result test if before/after hooks have a idle', async () => {
